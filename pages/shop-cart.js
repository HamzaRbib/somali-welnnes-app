                ...
                <div className="row mb-50">
                  ...
                  <div className="col-lg-6 col-md-12">
                    <div className="border p-md-4 p-30 border-radius cart-totals">
                      ...
                      <a onClick={handleProceedToCheckout} className="btn ">
  ...
  return (
    ...
    >
      ...
      <Modal.Body className="text-center pt-0 pb-5 px-5">
        {/* Image Section */}
        <div className="mb-4">
          {/* Replace this src with your actual image file import */}
          <img
        ...
        <p className="text-muted mb-4 px-3" style={{ fontSize: "0.95rem" }}>
          To place your order and access all features, please complete your
          login first. Logging in helps us serve you better!
        </p>
        ...
        <div className="d-flex gap-3 justify-content-center mb-15">
          <Button
            ...
            style={{
              backgroundColor: "#84a606", // The specific olive green from your image
              borderColor: "#84a606",
              padding: "10px 30px",
              fontWeight: "500",
            }}
          ...
          <Button
            variant="light" // Uses Bootstrap light theme base
            onClick={handleClose}
            style={{
              backgroundColor: "#fff",
              color: "black",
              border: "1px solid #000", // Black border
              padding: "10px 50px", // Wider padding to match image
              fontWeight: "500",
            }}
          >
            Cancel
